...
import 'package:flutter_laravel_mongodb_app/models/emp_model.dart';
import 'package:http/http.dart' as http;

class Services {
  static String baseUrl = 'http://192.168.8.165:8000/api/emps/';
  ...
  static Future<String> deleteEmp(String id) async {
    try {
